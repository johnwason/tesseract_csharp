 ...
 * std_unordered_map.i
 *
 * SWIG typemaps for std::unordered_map< K, T, Hash, KeyEqual, Allocator>
 *
...
%define SWIG_STD_UNORDERED_MAP_INTERNAL(K, T, Hash, KeyEqual, Allocator)

%typemap(csinterfaces) std::unordered_map< K, T, Hash, KeyEqual, Allocator > "global::System.IDisposable \n    , global::System.Collections.Generic.IDictionary<$typemap(cstype, K), $typemap(cstype, T)>\n";
%typemap(cscode) std::unordered_map<K, T, Hash, KeyEqual, Allocator> %{
...
%}
    ...
    public:
        ...
        unordered_map();
        unordered_map(const unordered_map< K, T, Hash, KeyEqual, Allocator> &other);
        ...
        %extend {
            ...
            std::unordered_map< K, T, Hash, KeyEqual, Allocator>::iterator iter = $self->find(key);
            if (iter != $self->end())
                return iter->second;
            else
            ...
            %apply void *VOID_INT_PTR { std::unordered_map< K, T, Hash, KeyEqual, Allocator >::iterator *create_iterator_begin }
            %apply void *VOID_INT_PTR { std::unordered_map< K, T, Hash, KeyEqual, Allocator >::iterator *swigiterator }

            std::unordered_map< K, T, Hash, KeyEqual, Allocator >::iterator *create_iterator_begin() {
            return new std::unordered_map< K, T, Hash, KeyEqual, Allocator >::iterator($self->begin());
            }

            const key_type& get_next_key(std::unordered_map< K, T, Hash, KeyEqual, Allocator >::iterator *swigiterator) {
            std::unordered_map< K, T, Hash, KeyEqual, Allocator>::iterator iter = *swigiterator;
            (*swigiterator)++;
            return (*iter).first;
            }

            void destroy_iterator(std::unordered_map< K, T, Hash, KeyEqual, Allocator>::iterator *swigiterator) {
            delete swigiterator;
            }
        }
...
namespace std {   
  template<class K, class T, class Hash = std::hash<K>, class KeyEqual = std::equal_to<K>, class Allocator = std::allocator< std::pair<const K, T> > > class unordered_map {
    SWIG_STD_UNORDERED_MAP_INTERNAL(K, T, Hash, KeyEqual, Allocator)
  };
}
