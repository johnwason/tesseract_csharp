...
%define tesseract_csimports(csimporttypes)
%typemap(csimports) SWIGTYPE csimporttypes;
%pragma(csharp) moduleimports=csimporttypes;
%pragma(csharp) imclassimports=csimporttypes;
%enddef
